...
HTMLHelper::_('script', 'com_contracts/script.js', array('version' => 'auto', 'relative' => true));
?>
<div class="row-fluid">
    ...
    <div id="j-main-container" class="span10">
        <form action="<?php echo ContractsHelper::getActionUrl(); ?>" method="post"
            ...
            <div>
                <a href="index.php?option=com_contracts&task=responsibles.execute&format=xls"><?php echo JText::sprintf('COM_CONTRACTS_ACTION_EXPORT_TO_EXCEL');?></a>
            </div>
